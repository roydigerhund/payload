...
const ListDrawerContent = ({ drawerSlug, onSelect, customHeader, collectionSlugs, selectedCollection, filterOptions, }) => {
    ...
    const [fields, setFields] = (0, react_1.useState)(() => (0, formatFields_1.default)(selectedCollectionConfig));
    (0, react_1.useEffect)(() => {
        setFields((0, formatFields_1.default)(selectedCollectionConfig));
