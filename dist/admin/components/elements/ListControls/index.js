        ...
        react_1.default.createElement("div", { className: `${baseClass}__wrap` },
            ...
            react_1.default.createElement("div", { className: `${baseClass}__buttons` },
                react_1.default.createElement("div", { className: `${baseClass}__buttons-wrap` },
                    ...
                    enableColumns && (react_1.default.createElement(Pill_1.default, { pillStyle: "light", className: `${baseClass}__toggle-columns ${visibleDrawer === 'columns' ? `${baseClass}__buttons-active` : ''}`, onClick: () => setVisibleDrawer(visibleDrawer !== 'columns' ? 'columns' : undefined), icon: react_1.default.createElement(Chevron_1.default, null) }, t('columns'))),
                    react_1.default.createElement(Pill_1.default, { pillStyle: "light", className: `${baseClass}__toggle-where ${visibleDrawer === 'where' ? `${baseClass}__buttons-active` : ''}`, onClick: () => setVisibleDrawer(visibleDrawer !== 'where' ? 'where' : undefined), icon: react_1.default.createElement(Chevron_1.default, null) }, t('filters')),
