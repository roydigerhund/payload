...
const Select = ({ field, locale, version, comparison, diffMethod }) => {
    ...
    return (react_1.default.createElement("div", { className: baseClass },
        ...
        react_1.default.createElement(react_diff_viewer_continued_1.default, { styles: styles_1.diffStyles, compareMethod: react_diff_viewer_continued_1.DiffMethod[diffMethod], oldValue: comparisonToRender, newValue: typeof versionToRender !== 'undefined' ? versionToRender : placeholder, splitView: true, hideLineNumbers: true, showDiffOnly: false })));
};
